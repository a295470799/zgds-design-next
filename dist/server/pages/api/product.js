    ...
    return (0,_utils_request__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)({
        ...
        return {
            product: {
                ...
                ean: "",
                name: "",
                long_name: "SONGMICS Clothes Rack on Wheels, Heavy Duty Clothes Rail, with Extendable Hanging Rail, 90 kg Load Capacity, Easy Assembly, Portable, Silver HSR13S",
                ...
                brand: "SONGMICS",
                label: "",
                feature: "Enhanced Load Capacity: Thanks to the 1 mm thick steel tubes, which are thicker and sturdier than normal 0.8 mm thick ones, and the heavy-duty PP castors, this clothes rack supports up to 90 kg. So feel free to hang your heavy coats on![.]Extendable Hanging Rail: Each end of the top rail extends an additional 20 cm to give you more hanging space (the top rail extends from 92 cm to 132 cm); the 2 extension ends are also ideal for hanging your handbags, hats, scarves, or other accessories on[.]Easy to Move and Lock: This clothes rail comes with 4 360\xb0 swivel castors, 2 of which are lockable, allowing you to move it from your bedroom to your coatroom with ease and lock it in place if needed[.]Easy to Assemble and Store: No tools are needed to set up this clothing rail, and it can be ready in just 3 steps! When not in use, you can disassemble it and put it away under your bed or in an unused corner quickly to save space[.]Versatile Use: This clothes rail comes with 2 bottom bars for your storage boxes, making it functional whether in your bedroom or cloakroom to store daily items or in your laundry room to dry clothes. The chrome-plated steel also allows for outdoor use",
                content: "Specifications:<br/>- Colour: Silver<br/>- Material: Steel, PP Castors<br/>- Product Size: 45.4 x (92<br/>-132) x 160 cm (D x W x H)<br/>- Product Weight: 5 kg<br/>- Max. Static Load Capacity: 90 kg <br/><br/>Package Contents:<br/>- 1 x Clothes Rack<br/>- 1 x Instructions",
                ...
                features: [
                    ...
                    "Easy to Move and Lock: This clothes rail comes with 4 360\xb0 swivel castors, 2 of which are lockable, allowing you to move it from your bedroom to your coatroom with ease and lock it in place if needed",
...
var __webpack_exports__ = __webpack_require__.X(0, [688], () => (__webpack_exec__(3715)));
